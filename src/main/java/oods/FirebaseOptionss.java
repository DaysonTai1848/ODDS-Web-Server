...
public final class FirebaseOptionss {
  ...
  private FirebaseOptionss(@NonNull final FirebaseOptionss.Builder builder) {
  ...
  /**
   * Builder for constructing {@link FirebaseOptionss}.
   */
  public static final class Builder {
     ...
     *
     * @deprecated Use {@link FirebaseOptionss#builder()} instead.
     */
    @Deprecated
    public Builder() {}
     ...
     * builder don't change the values of the origin object.
     *
     * @deprecated Use {@link FirebaseOptionss#toBuilder()} instead.
     */
    @Deprecated
    public Builder(FirebaseOptionss options) {
     ...
     * must be specified when creating a new instance of {@link FirebaseOptionss}.
     *
     * <p>See <a href="https://firebase.google.com/docs/admin/setup#initialize_the_sdk">
     * Initialize the SDK</a> for code samples and detailed documentation.
     *
    ...
    /**
     * Builds the {@link FirebaseOptionss} instance from the previously set options.
     *
     * @return A {@link FirebaseOptionss} instance created from the previously set options.
     */
    public FirebaseOptionss build() {
      return new FirebaseOptionss(this);
    }
  }
}
